...
The following are the network security problem for Company A based on the business requirement given in the scenario.
1.Denial of service: This usually  occurs when the network resources are overloaded with bogus requests or traffics, making them unavailable to  legitimate users.  If this event should happen, company A’s website may become unavailable for customers to access, internal operations may become impossible to carry out, customers account information may become unavailable.
2.Data breaches: This occurs when an entity gains unauthorized access to sensitive  customer information.  Company A deals with the financial data of their customers,and  these  data have  a very high hack value, making it  a target for bad actors. A Data breach happening to Company may lead to exposure of customers financial data, which may cause huge financial loss to both customers and the company. 
3.Single point of failure: Company A relies solely on their on premises to provide their services or solution to the customers. An Attack on their on-premise network may cause downtime, as there’s no cloud infrastructure to complement their on-premises activities.  This single point of failure may lead to disruption of services, and customers may be unable to access their accounts,  investments or carry out online transaction using their cards.
4.Non Compliance with Regulatory standards: Company A falls in the financial sector where PCI DSS is the Regulatory standard.  Not being in compliant with this regulations may attract regulatory fines, legal consequences or Reputational damage.


The following are the Infrastructure problem for Company A  based on the business requirement given in the scenario.
...
2.Redundancy: This is achieved when critical network infrastructure is duplicated to ensure the continuation of services, in the face of fault or attack. The presence of cloud infrastructure would have helped company A achieved this, and help maintain availability of their services to their customers at all time.
3.Lack of a VPN for the remote desktop access: Enabling remote desktop connection (RDP) over the internet without a proper implementation of VPN introduces security risks such as unauthorized access, bruteforce attack and network eavesdropping. The presence of a VPN helps to secure the communication between the remote desktop and internal Computer VLAN of the company.
